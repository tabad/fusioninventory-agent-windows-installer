...
# @file      .\Perl\Scripts\show-missing-perl-modules-and-dependencies.sh
# @author    Tomas Abad
...
while (( ${iter} < ${#archs[@]} )); do
   ...
   # Show missing modules dependencies
   echo "Missing Strawberry Perl ${strawberry_release} (${strawberry_version}-${arch_label}s) modules dependencies..."

   ${perl} ${cpanm} --scandeps --auto-cleanup 1 --quiet                            \
