...
Function TargetsPage_Create
   ...
   ${NSD_CreateGroupBox} 0u 27u 294u 54u "$(TargetsPage_GroupBox1_Text)"
   Pop $hCtl_TargetsPage_GroupBox1

   ; === TextBox1 (type: Text) ===
   ${NSD_CreateText} 11u 43u 271u 11u ""
   Pop $hCtl_TargetsPage_TextBox1

   ; === Label1 (type: Label) ===
   ${NSD_CreateLabel} 11u 59u 271u 18u "$(TargetsPage_Label1_Text)"
   Pop $hCtl_TargetsPage_Label1
   ${NSD_AddStyle} $hCtl_TargetsPage_Label1 ${SS_CENTER}

   ; === CheckBox1 (type: Checkbox) ===
   ${NSD_CreateCheckbox} 11u 90u 271u 11u "$(TargetsPage_CheckBox1_Text)"
   ...
   ; Set focus on TextBox1 whether TextBox1 is empty
   ${NSD_GetText} $hCtl_TargetsPage_TextBox1 $R1
   ${If} "$R1" == ""
      ${NSD_SetFocus} $hCtl_TargetsPage_TextBox1
   ${EndIf}
