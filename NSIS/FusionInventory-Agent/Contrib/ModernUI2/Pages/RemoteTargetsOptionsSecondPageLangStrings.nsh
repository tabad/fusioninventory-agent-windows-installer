/*
   ...
   @file      .\FusionInventory Agent\Contrib\ModernUI2\Pages\RemoteTargetsOptionsSecondPageLangStrings.nsh
...
!ifndef __FIAI_REMOTEOPTIONSSECONDPAGE_LANGSTRINGS_INCLUDE__
!define __FIAI_REMOTEOPTIONSSECONDPAGE_LANGSTRINGS_INCLUDE__
