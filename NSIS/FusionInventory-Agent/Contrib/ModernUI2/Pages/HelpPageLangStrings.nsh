...
LangString HelpPage_Help_Option_installtype_Paragraph_1 ${LANG_ENGLISH} "Selects between an installation from the beginning (\b from-scratch\b0 ) or, whether you have currently an agent installed, an installation based on the current configuration (\b from-current-config\b0 ). (By default: \b $R9\b0 )"
LangString HelpPage_Help_Option_installtype_Paragraph_1 ${LANG_FRENCH} "fSelects between an installation from the beginning (\b from-scratch\b0 ) or, whether you have currently an agent installed, an installation based on the current configuration (\b from-current-config\b0 ). (By default: \b $R9\b0 )"
LangString HelpPage_Help_Option_installtype_Paragraph_1 ${LANG_SPANISH} "Selecciona entre una instalación desde cero (\b from-scratch\b0 ) o, si tiene actualmente un agente instalado, una instalación basada en la configuración actual (\b from-current-config\b0 ). (Por defecto: \b $R9\b0 )"
