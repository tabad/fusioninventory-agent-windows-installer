...
LangString InstallationTypePage_SubText ${LANG_FRENCH} "Choisissez où vous désirez installer ${PRODUCT_NAME}."
...
LangString InstallationTypePage_Label1_Text ${LANG_FRENCH} "Vous avez l'Agent FusionInventory $R0 ($R1 édition) déjà d'installé sur votre machine. Dans ce cas, vous avez deux types d'installation possible pour installer cette nouvelle version.$\r$\n$\r$\nVous devez choisir si vous voulez :"
...
LangString InstallationTypePage_RadioButton1_Text ${LANG_FRENCH} "Installer à partir de zéro"
...
LangString InstallationTypePage_Label2_Text ${LANG_FRENCH} "Le nouvel Agent FusionInventory sera installé avec les options paramétrées par défaut."
...
LangString InstallationTypePage_Label3_Text ${LANG_FRENCH} "Le nouvel Agent FusionInventory sera installé avec les options paramétrées selon la configuration actuelle."
