/*
   ...
   @file      .\FusionInventory Agent\Contrib\ModernUI2\Pages\DebugOptionsPageLangStrings.nsh
...
!ifndef __FIAI_DEBUGOPTIONSPAGE_LANGSTRINGS_INCLUDE__
!define __FIAI_DEBUGOPTIONSPAGE_LANGSTRINGS_INCLUDE__
