/*
   ...
   @file      .\FusionInventory Agent\Contrib\ModernUI2\Pages\WindowsTaskOptionsPageLangStrings.nsh
...
!ifndef __FIAI_WINDOWSTASKOPTIONSPAGE_LANGSTRINGS_INCLUDE__
!define __FIAI_WINDOWSTASKOPTIONSPAGE_LANGSTRINGS_INCLUDE__
