...
; IsValidOptionWaitValue
!define IsValidOptionWaitValue `"" IsValidOptionWaitValue`

!macro _IsValidOptionWaitValue _a _b _t _f
   !insertmacro _LOGICLIB_TEMP
   Push `${_b}`
   Call IsValidOptionWaitValue
   Pop $_LOGICLIB_TEMP
   !insertmacro _= $_LOGICLIB_TEMP 0 `${_t}` `${_f}`
!macroend

Function IsValidOptionWaitValue
   ; $R0 Option value
   ; $R1 Error code
