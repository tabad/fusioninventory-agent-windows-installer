...
!else
   !if "${PRODUCT_RELEASE_TYPE}" == "${RELEASE_TYPE_CANDIDATE}"
      ...
      !define PRODUCT_VERSION "2.3.3-rc3"
      ...
      !define PRODUCT_VERSION_MINOR "3"
      !define PRODUCT_VERSION_RELEASE "3"
      !define PRODUCT_VERSION_CANDIDATE "3"
      ...
      ; If PRODUCT_VERSION is a commit then
      ;    define the following symbols as '0.0.0.0'
      !define FILE_VERSION "2.3.2.9903"
   ...
   !else
      ...
      !define PRODUCT_VERSION "e3d7a9ccd9-dev"
